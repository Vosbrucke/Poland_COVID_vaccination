...
setwd("/Users/mr.fox/Github/COVID_wg_powiatow/Raw_data/danehistorycznepowiaty/")

files_1 <- list.files(path = "/Users/mr.fox/Github/COVID_wg_powiatow/Raw_data/danehistorycznepowiaty", pattern = ".csv")[31:65]

df_no_date <- ldply(.data = files, .fun = function(i) {read.csv(i, header = TRUE, sep = ";", dec = ",", stringsAsFactors = FALSE, na.strings = c("", "NA")) })
